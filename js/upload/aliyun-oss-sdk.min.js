...
! function (t) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = t();
        ...
        var e;
        e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, e.OSS = t()
    }
}(function () {
    var t;
    return function () {
        ...
        2: [function (t, e, r) {
            (function (r, n) {
                ...
                function c(t, e, r) {
                    ...
                    return "vpc100-oss-cn-" === t.substr(0, "vpc100-oss-cn-".length) && (i = ".aliyuncs.com"), E.parse(n + t + i)
                }
                ...
                var M = o.prototype;
                x(M, t("./object")), x(M, t("./managed_upload")), x(M, t("../common/multipart")), x(M, t("../common/thunkpool.js")), o.Wrapper = t("./wrapper"), M.signature = function (t) {
                    ...
                    var u = [];
                    (0, d.default)(o).sort().forEach(function (t) {
                        u.push(t + ":" + o[t].join(","))
                    }), i = i.concat(u);
                    var l = "";
                    l += e;
                ...
                }, M.request = p.default.mark(function t(e) {
                    var r, n, i, o;
                    ...
                    return function (e) {
                        n.isBuffer(t) && (t = t.toString()), g.parseString(t, {
                            explicitRoot: !1,
                            explicitArray: !1
                        }, e)
                    }
                }, M.requestError = p.default.mark(function t(e) {
                    var r, n, i;
                    return p.default.wrap(function (t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                        ...
                        for (;;) switch (t.prev = t.next) {
                            ...
                            case 2:
                                if (n = e.file, i = e.fileSize, o = e.partSize, s = e.uploadId, u = e.doneParts, l = e.name, p = this._divideParts(i, o), f = p.length, d = c.default.mark(function t(i, o) {
                                    ...
                                    }), h = (0, a.default)(new Array(f), function (t, e) {
                                        return e + 1
                                    }), m = u.map(function (t) {
                                        return t.number
            ...
            h.append = i.default.mark(function t(e, r, n) {
                    ...
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 4:
                            if (o = t.sent, a = {
                                ...
                                for (s in o.headers) 0 === s.indexOf("x-oss-meta-") && (a.meta || (a.meta = {}), a.meta[s.substring(11)] = o.headers[s]);
                ...
                return i.default.wrap(function (t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 14:
                            return u = t.sent, l = u.data, p = l && l.Deleted || null, p && (Array.isArray(p) || (p = [p]), p = p.map(function (t) {
                                return t.Key
                            })), t.abrupt("return", {
                                res: u.res,
                                deleted: p
                ...
                return i.default.wrap(function (t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 6:
                            return o = t.sent, a = o.data.Contents, s = this, a && (Array.isArray(a) || (a = [a]), a = a.map(function (t) {
                                return {
                                    name: t.Key,
                            ...
                            })), c = o.data.CommonPrefixes || null, c && (Array.isArray(c) || (c = [c]), c = c.map(function (t) {
                                return t.Prefix
                            })), t.abrupt("return", {
                                res: o.res,
                                objects: a,
                ...
                if (t)
                    for (var r in t) e["x-oss-meta-" + r] = t[r]
            ...
            (function (e) {
                ...
                r.encodeCallback = function (t) {
                    if (t.headers = t.headers || {}, !t.headers.hasOwnProperty("x-oss-callback") && t.callback) {
                        ...
                        var n = new e((0, i.default)(r)).toString("base64");
        ...
        8: [function (t, e, r) {
            ...
            a.listUploads = i.default.mark(function t(e, r) {
                ...
                return i.default.wrap(function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return o = o || {}, o.subres = {
                                uploadId: r
                            }, a = this._objectRequestParams("GET", e, o), a.query = n, a.xmlResponse = !0, a.successStatuses = [200], t.next = 8, this.request(a);
                        case 8:
                ...
                return i.default.wrap(function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return this.cancel(), n = n || {}, n.subres = {
                                uploadId: r
                            }, o = this._objectRequestParams("DELETE", e, n), o.successStatuses = [204], t.next = 7, this.request(o);
                        case 7:
                            return a = t.sent, t.abrupt("return", {
                                res: a.res
                            });
                ...
                return i.default.wrap(function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            ...
                            return s += "</CompleteMultipartUpload>", a = a || {}, a.subres = {
                                uploadId: r
                            }, l = this._objectRequestParams("POST", e, a), l.mime = "xml", l.content = s, o.encodeCallback(a), a.headers && a.headers["x-oss-callback"] || (l.xmlResponse = !0), l.successStatuses = [200], t.next = 14, this.request(l);
                        case 14:
                            return p = t.sent, f = {
                                res: p.res,
                                bucket: l.bucket,
            ...
            e.exports = function (t, e) {
                return function (r, i) {
                    ...
                    if (null === n && o && (n = t["@@any-promise/REGISTRATION"] || null),
                        null !== n && null !== r && n.implementation !== r) throw new Error('any-promise already defined as "' + n.implementation + '".  You can only register an implementation before the first  call to require("any-promise") and an implementation cannot be changed');
        ...
        36: [function (t, e, r) {
            (function (e, n) {
                ...
                function o(t, e) {
                    ...
                    return n.TYPED_ARRAY_SUPPORT ? (t = new Uint8Array(e), t.__proto__ = n.prototype) : (null === t && (t = new n(e)), t.length = e), t
                }
                ...
                function f(t, e, r, i) {
                    ...
                    return e = void 0 === r && void 0 === i ? new Uint8Array(e) : void 0 === i ? new Uint8Array(e, r) : new Uint8Array(e, r, i), n.TYPED_ARRAY_SUPPORT ? (t = e, t.__proto__ = n.prototype) : t = p(t, e), t
                }
                ...
                function g(t, e, r, i, o) {
                    ...
                    if ("number" == typeof e) return e &= 255, n.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? o ? Uint8Array.prototype.indexOf.call(t, e, r) : Uint8Array.prototype.lastIndexOf.call(t, e, r) : _(t, [e], r, i, o);
                ...
                var $ = t("base64-js"),
                    Q = t("ieee754"),
                    J = t("isarray");
                r.Buffer = n, r.SlowBuffer = m, r.INSPECT_MAX_BYTES = 50, n.TYPED_ARRAY_SUPPORT = void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : function () {
                    try {
                    ...
                    for (var a = o - i, s = r - e, c = Math.min(a, s), u = this.slice(i, o), l = t.slice(e, r), p = 0; p < c; ++p)
                        if (u[p] !== l[p]) {
                            a = u[p], s = l[p];
                            break
                ...
                n.prototype.slice = function (t, e) {
                    ...
                    return t = +t, e |= 0, r || P(this, t, e, 1, 255, 0), n.TYPED_ARRAY_SUPPORT || (t = Math.floor(t)), this[e] = 255 & t, e + 1
                }, n.prototype.writeUInt16LE = function (t, e, r) {
                    return t = +t, e |= 0, r || P(this, t, e, 2, 65535, 0), n.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : D(this, t, e, !0), e + 2
                }, n.prototype.writeUInt16BE = function (t, e, r) {
                    return t = +t, e |= 0, r || P(this, t, e, 2, 65535, 0), n.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8,
                        this[e + 1] = 255 & t) : D(this, t, e, !1), e + 2
                }, n.prototype.writeUInt32LE = function (t, e, r) {
                    return t = +t, e |= 0, r || P(this, t, e, 4, 4294967295, 0), n.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : R(this, t, e, !0), e + 4
                }, n.prototype.writeUInt32BE = function (t, e, r) {
                    return t = +t, e |= 0, r || P(this, t, e, 4, 4294967295, 0), n.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : R(this, t, e, !1), e + 4
                    ...
                    return t = +t, e |= 0, r || P(this, t, e, 1, 127, -128), n.TYPED_ARRAY_SUPPORT || (t = Math.floor(t)), t < 0 && (t = 255 + t + 1), this[e] = 255 & t, e + 1
                }, n.prototype.writeInt16LE = function (t, e, r) {
                    return t = +t, e |= 0, r || P(this, t, e, 2, 32767, -32768), n.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : D(this, t, e, !0), e + 2
                }, n.prototype.writeInt16BE = function (t, e, r) {
                    return t = +t, e |= 0, r || P(this, t, e, 2, 32767, -32768), n.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : D(this, t, e, !1), e + 2
                }, n.prototype.writeInt32LE = function (t, e, r) {
                    return t = +t, e |= 0, r || P(this, t, e, 4, 2147483647, -2147483648), n.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : R(this, t, e, !0), e + 4
                }, n.prototype.writeInt32BE = function (t, e, r) {
                    return t = +t, e |= 0, r || P(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), n.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : R(this, t, e, !1), e + 4
            ...
            function s(t) {
                for (var e = new t.constructor, r = Object.keys(t), n = [], o = 0; o < r.length; o++) {
                    var a = r[o],
                        s = i.call(this, t[a]);
                    s && c(s) ? function (t, r) {
                        e[r] = void 0, n.push(t.then(function (t) {
                            e[r] = t
                        }))
                    }(s, a) : e[a] = t[a]
                }
        ...
        86: [function (t, e, r) {
            ...
            e.exports = function (t, e, r, h, m, v, b) {
                ...
                if (A && (_ = l(A.call(new t))) !== Object.prototype && _.next && (u(_, x, !0), n || "function" == typeof _[p] || a(_, p, d)), E && k && "values" !== k.name && (S = !0, j = function () {
                        return k.call(this)
                    }), n && !b || !f && !S && T[p] || a(T, p, j), s[e] = j, s[x] = d, m)
                    if (y = {
                            values: E ? j : w("values"),
                            keys: v ? j : w("keys"),
                            entries: O
        ...
        94: [function (t, e, r) {
            ...
            e.exports = !c || t("./_fails")(function () {
                ...
                for (var r = a(t), c = arguments.length, u = 1, l = i.f, p = o.f; c > u;)
                    for (var f, d = s(arguments[u++]), h = l ? n(d).concat(l(d)) : n(d), m = h.length, v = 0; m > v;) p.call(d, f = h[v++]) && (r[f] = d[f]);
                return r
            } : c
        }, {
            "./_fails": 72,
            ...
            i(i.S + i.F * !t("./_iter-detect")(function (t) {
                ...
                from: function (t) {
                    var e, r, i, p, f = o(t),
                        ...
                        b = 0,
                        y = l(f);
                    if (v && (m = n(m, h > 2 ? arguments[2] : void 0, 2)), void 0 == y || d == Array && s(y))
                        for (e = c(f.length), r = new d(e); e > b; b++) u(r, b, v ? m(f[b], b) : f[b]);
                    else
                        for (p = y.call(f), r = new d; !(i = p.next()).done; b++) u(r, b, v ? a(p, m, [i.value, b], !0) : i.value);
                    return r.length = b, r
                }
            })
        }, {
        ...
        141: [function (t, e, r) {
            ...
            C || (j = function (t) {
                ...
                Promise: j
            }), t("./_set-to-string-tag")(j, "Promise"), t("./_set-species")("Promise"), a = t("./_core").Promise, p(p.S + p.F * !C, "Promise", {
                reject: function (t) {
                    var e = N(this);
        ...
        144: [function (t, e, r) {
            ...
            q || (C = function () {
                ...
                var t = f(arguments.length > 0 ? arguments[0] : void 0),
                    e = function (r) {
                        this === F && e.call(B, r), i(this, L) && i(this[L], t) && (this[L][t] = !1), z(this, t, x(1, r))
                    };
                return o && G && z(F, t, {
                    configurable: !0,
                    set: e
        ...
        155: [function (t, e, r) {
            ! function () {
                var t, r, n = this;
                t = function (t) {
                    for (var e, e, r = new Array(t), n = 0; n < t; n++) 0 == (3 & n) && (e = 4294967296 * Math.random()), r[n] = e >>> ((3 & n) << 3) & 255;
                    return r
                ...
                (function () {
                    ...
                    function h(t) {
                        ...
                        if (U && (U = [U]), q && !F && (F = e([q])), (b = /\bGoogle TV\b/.exec(F)) && (F = b[0]), /\bSimulator\b/i.test(t) && (F = (F ? F + " " : "") + "Simulator"), "Opera Mini" == B && /\bOPiOS\b/.test(t) && L.push("running in Turbo/Uncompressed mode"), "IE" == B && /\blike iPhone OS\b/.test(t) ? (b = h(t.replace(/like iPhone OS/, "")), q = b.manufacturer, F = b.product) : /^iP/.test(F) ? (B || (B = "Safari"), X = "iOS" + ((b = / OS ([\d_]+)/i.exec(t)) ? " " + b[1].replace(/_/g, ".") : "")) : "Konqueror" != B || /buntu/i.test(X) ? q && "Google" != q && (/Chrome/.test(B) && !/\bMobile Safari\b/i.test(t) || /\bVita\b/.test(F)) || /\bAndroid\b/.test(X) && /^Chrome/.test(B) && /\bVersion\//i.test(t) ? (B = "Android Browser", X = /\bAndroid\b/.test(X) ? X : "Android") : "Silk" == B ? (/\bMobi/i.test(t) || (X = "Android", L.unshift("desktop mode")), /Accelerated *= *true/i.test(t) && L.unshift("accelerated")) : "PaleMoon" == B && (b = /\bFirefox\/([\d.]+)\b/.exec(t)) ? L.push("identifying as Firefox " + b[1]) : "Firefox" == B && (b = /\b(Mobile|Tablet|TV)\b/i.exec(t)) ? (X || (X = "Firefox OS"), F || (F = b[1])) : !B || (b = !/\bMinefield\b/i.test(t) && /\b(?:Firefox|Safari)\b/.exec(B)) ? (B && !F && /[\/,]|^[^(]+?\)/.test(t.slice(t.indexOf(b + "/") + 8)) && (B = null), (b = F || q || X) && (F || q || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(X)) && (B = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(X) ? X : b) + " Browser")) : "Electron" == B && (b = (/\bChrome\/([\d.]+)\b/.exec(t) || 0)[1]) && L.push("Chromium " + b) : X = "Kubuntu", R || (R = function (e) {
                            ...
                            if (l(n, "global"))
                                if (k && (b = k.lang.System, I = b.getProperty("os.arch"), X = X || b.getProperty("os.name") + " " + b.getProperty("os.version")), j) {
                                    try {
                        ...
                        else if (/\bXbox\b/i.test(F)) "Xbox 360" == F && (X = null), "Xbox 360" == F && /\bIEMobile\b/.test(t) && L.unshift("mobile mode");
                        ...
                        var G = {};
                        return G.description = t, G.layout = U && U[0], G.manufacturer = q, G.name = B, G.prerelease = P, G.product = F, G.ua = t, G.version = B && R, G.os = X || {
                            architecture: null,
                            family: null,
                            version: null,
                            toString: function () {
                ...
                ! function (i) {
                    ...
                    function h(t) {
                        ...
                        for (n = i = _.length, i && _.push(N); n < v;) {
                            ...
                            for (b = n + 1, u - e > D((x - r) / b) && o("overflow"), r += (u - e) * b, e = u, s = 0; s < v; ++s)
                    ...
                    if (_ = {
                        ...
                        if (r.exports == b) y.exports = _;
                            ...
                            for (w in _) _.hasOwnProperty(w) && (b[w] = _[w]);
                    else i.punycode = _
                }(this)
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {}],
        ...
        186: [function (t, e, r) {
            (function (r, n) {
                ...
                function v(t) {
                    ...
                    e.needReadable = !1, e.emittedReadable || (G("emitReadable", e.flowing), e.emittedReadable = !0, e.sync ? L.nextTick(b, t) : b(t))
                }
                ...
                c.prototype.read = function (t) {
                    ...
                    var e = this._readableState,
                        r = t;
                    if (0 !== t && (e.emittedReadable = !1), 0 === t && e.needReadable && (e.length >= e.highWaterMark || e.ended)) return G("read: emitReadable", e.length, e.ended), 0 === e.length && e.ended ? A(this) : v(this), null;
                    if (0 === (t = h(t, e)) && e.ended) return 0 === e.length && A(this), null;
                    var n = e.needReadable;
                    G("need readable", n), (0 === e.length || e.length - t < e.highWaterMark) && (n = !0, G("length less than watermark", n)), e.ended || e.reading ? (n = !1, G("reading or ended", n)) : n && (G("do read"), e.reading = !0, e.sync = !0, 0 === e.length && (e.needReadable = !0), this._read(e.highWaterMark), e.sync = !1, e.reading || (t = h(r, e)));
                    var i;
                    ...
                    function s(e) {
                        G("ondata"), y = !1, !1 !== t.write(e) || y || ((1 === d.pipesCount && d.pipes === t || d.pipesCount > 1 && -1 !== C(d.pipes, t)) && !b && (G("false write response, pause", f._readableState.awaitDrain), f._readableState.awaitDrain++, y = !0), f.pause())
                    }
                ...
                e = t("xmlbuilder"), n = t("./defaults").defaults, a = function (t) {
                    ...
                    return t.prototype.buildObject = function (t) {
                        ...
                        return r = this.options.attrkey, i = this.options.charkey, 1 === (0, s.default)(t).length && this.options.rootName === n[.2].rootName ? (f = (0, s.default)(t)[0], t = t[f]) : f = this.options.rootName, l = function (t) {
                            return function (e, n) {
                                var s, p, f, d, h, m;
                                if ("object" !== (void 0 === n ? "undefined" : (0, o.default)(n))) t.options.cdata && a(n) ? e.raw(c(n)) : e.txt(n);
                                    ...
                                    for (d in p) u.call(p, d) && (f = p[d], e = "string" == typeof f ? t.options.cdata && a(f) ? e.ele(h).raw(c(f)).up() : e.ele(h, f).up() : l(e.ele(h), f).up());
                        ...
                        return this.removeAllListeners(), this.saxParser = p.parser(this.options.strict, {
                            ...
                            return function () {
                                ...
                                if (d = n.pop(), f = d["#name"], t.options.explicitChildren && t.options.preserveChildrenOrder || delete d["#name"], !0 === d.cdata && (r = d.cdata, delete d.cdata), b = n[n.length - 1], d[e].match(/^\s*$/) && !r ? (i = d[e], delete d[e]) : (t.options.trim && (d[e] = d[e].trim()), t.options.normalize && (d[e] = d[e].replace(/\s{2,}/g, " ").trim()), d[e] = t.options.valueProcessors ? c(t.options.valueProcessors, d[e], f) : d[e], 1 === (0, s.default)(d).length && e in d && !t.EXPLICIT_CHARKEY && (d = d[e])), a(d) && (d = "" !== t.options.emptyTag ? t.options.emptyTag : i), null != t.options.validator && (y = "/" + function () {
                                    ...
                                    }()), t.options.explicitChildren && !t.options.mergeAttrs && "object" === (void 0 === d ? "undefined" : (0, u.default)(d)))
        ...
        219: [function (t, e, r) {
            ...
            (function () {
                ...
                t = function () {
                    var t, e, r, n, o, a;
                    if (a = arguments[0], o = 2 <= arguments.length ? l.call(arguments, 1) : [], i(u.default)) u.default.apply(null, arguments);
                    else
            ...
            (function () {
                ...
                _ = t("./Utility"), y = _.isObject, b = _.isFunction, g = _.isPlainObject, p = t("./XMLElement"), n = t("./XMLCData"), i = t("./XMLComment"), d = t("./XMLRaw"), v = t("./XMLText"), f = t("./XMLProcessingInstruction"), u = t("./XMLDeclaration"), l = t("./XMLDocType"), o = t("./XMLDTDAttList"), s = t("./XMLDTDEntity"), a = t("./XMLDTDElement"), c = t("./XMLDTDNotation"), r = t("./XMLAttribute"), m = t("./XMLStringifier"), h = t("./XMLStringWriter"), e.exports = function () {
                    ...
                    return t.prototype.node = function (t, e, r) {
                        ...
                        else b(e) && (e = e.apply()), this.options.skipNullAttributes && null == e || (this.currentNode.attributes[t] = new r(this, t, e));
                        return this
            ...
            (function () {
                ...
                d = t("./Utility"), f = d.isObject, p = d.isFunction, l = d.isEmpty, a = null, r = null, n = null, i = null, o = null, c = null, u = null, s = null, e.exports = function () {
                    ...
                    return e.prototype.element = function (t, e, r) {
                        ...
                        if (c = null, null == e && (e = {}), e = e.valueOf(), f(e) || (m = [e, r], r = m[0], e = m[1]), null != t && (t = t.valueOf()), Array.isArray(t))
                            for (o = 0, u = t.length; o < u; o++) i = t[o], c = this.element(i);
                        else if (p(t)) c = this.element(t.apply());
                        else if (f(t)) {
                            for (s in t)
                                if (h.call(t, s))
                                    if (v = t[s], p(v) && (v = v.apply()), f(v) && l(v) && (v = null), !this.options.ignoreDecorators && this.stringify.convertAttKey && 0 === s.indexOf(this.stringify.convertAttKey)) c = this.attribute(s.substr(this.stringify.convertAttKey.length), v);
                                    else if (!this.options.separateArrayItems && Array.isArray(v))
                                for (a = 0, d = v.length; a < d; a++) i = v[a], n = {}, n[s] = i, c = this.element(n);
            ...
            (function () {
                ...
                c = t("./XMLDeclaration"), u = t("./XMLDocType"), r = t("./XMLCData"), n = t("./XMLComment"), l = t("./XMLElement"), f = t("./XMLRaw"), d = t("./XMLText"), p = t("./XMLProcessingInstruction"), i = t("./XMLDTDAttList"), o = t("./XMLDTDElement"), a = t("./XMLDTDEntity"), s = t("./XMLDTDNotation"), h = t("./XMLWriterBase"), e.exports = function (t) {
                    ...
                    return m(e, t), e.prototype.document = function (t) {
                        ...
                        var c, u, l, f;
                        if (e || (e = 0), this.stream.write(this.space(e)),
                            this.stream.write("<!DOCTYPE " + t.root().name), t.pubID && t.sysID ? this.stream.write(' PUBLIC "' + t.pubID + '" "' + t.sysID + '"') : t.sysID && this.stream.write(' SYSTEM "' + t.sysID + '"'), t.children.length > 0) {
                ...
                r.request = function (e, n, i) {
                    ...
                    if (!a.content && G && "string" != typeof G && !n.isBuffer(G))
                        if (z) G = a.nestedQuerystring ? qs.stringify(G) : querystring.stringify(G);
                            ...
                            H || (H = "json" === a.contentType ? "application/json" : "application/x-www-form-urlencoded", U.headers["Content-Type"] = H), G = "application/json" === parseContentType(H).type ? (0, u.default)(G) : a.nestedQuerystring ? qs.stringify(G) : querystring.stringify(G)
